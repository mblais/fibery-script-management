//.fibery AUTOID=655e627c7f5fce9023b224da ACTIONID=c6baf4d3-f9ce-4a7c-8f5b-147557bc9b5d
...
async function cloneEntityFromTemplate({ type, subject, templateId=null, context }) {
    ...
    for ( const fieldObject of subject.fieldObjects ) {
        ...
        if ( ourExpresssionFieldObject ) {
            dbg(`Auto-linked relation: our[${ourExpresssionFieldObject.title}] = [${otherExpresssionFieldObject.type}].[${otherExpresssionFieldObject.title}]`)
            ...
            if ( fieldName===templateTargetsField || fieldObject.isReadOnly )
