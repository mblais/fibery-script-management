//.fibery SCRIPTID=64bb054340bcfc4371948ce7 ACTIONID=2e283d54-2bf8-4be0-95e5-187d50beeee4
...
function describeField( fieldId ) {
    ...
    return `[${fieldObject.holderType}] "${fieldObject.name}" ${fieldObject.isReadOnly ? '(RO)':''}`
}
